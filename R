...
local Window = Library.CreateLib("Reach script ", "Midnight")
local Tab = Window:NewTab("REACH")

local Section4 = Tab:NewSection("")

Section4:NewLabel("Reach ")

Section4:NewToggle("ENABLE REACH", "ToggleInfo", function(arg)
if arg then
...
Section4:NewSlider("REACH", "SliderInfo", 100, 0, function(arg) -- 100 (MaxValue) | 0 (MinValue)
   DistanceReach = arg
end)
